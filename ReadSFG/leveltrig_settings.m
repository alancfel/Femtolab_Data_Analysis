function varargout = leveltrig_settings(varargin)
% LEVELTRIG_SETTINGS M-file for leveltrig_settings.fig
%      LEVELTRIG_SETTINGS, by itself, creates a new LEVELTRIG_SETTINGS or raises the existing
%      singleton*.
%
%      H = LEVELTRIG_SETTINGS returns the handle to a new LEVELTRIG_SETTINGS or the handle to
%      the existing singleton*.
%
%      LEVELTRIG_SETTINGS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in LEVELTRIG_SETTINGS.M with the given input arguments.
%
%      LEVELTRIG_SETTINGS('Property','Value',...) creates a new LEVELTRIG_SETTINGS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before simple_gui_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to leveltrig_settings_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help leveltrig_settings

% Copyright 2001-2003 The MathWorks, Inc.

% Last Modified by GUIDE v2.5 10-Aug-2014 18:46:50

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @leveltrig_settings_OpeningFcn, ...
    'gui_OutputFcn',  @leveltrig_settings_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before leveltrig_settings is made visible.
function leveltrig_settings_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to leveltrig_settings (see VARARGIN)
...
% Choose default command line output for leveltrig_settings
handles.output = hObject;
% Update handles structure
guidata(hObject, handles);

% UIWAIT makes leveltrig_settings wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = leveltrig_settings_OutputFcn(hObject, eventdata, handles)
...
%close(leveltrig_settings);
drawnow;
global LvlTrigLevelTwosComp;
global LvlTrigCh;
global LvlTrigEdge;
%configure;
%leveltrig_settings_OutputFcn(hObject, eventdata, handles);
% set(handles.textStatus, 'String', 'Setup completed')
if isnan(LvlTrigLevelTwosComp) || LvlTrigLevelTwosComp > 8191 || LvlTrigLevelTwosComp < -8191
