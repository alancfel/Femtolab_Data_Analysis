...
if header.version>=3.0
    ...
    sensor = readstruct('temp.xml');
    sp.roix = sensor.Calibrations.SensorMapping.xAttribute;
    sp.accumulations = readXMLdata(DOMnode, 'Accumulations');
    sp.framesCombined = readXMLdata(DOMnode, 'FramesCombined');
