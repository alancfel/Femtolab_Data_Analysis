...
imshow(rgb,'XData',[0 size(rgb,2)*0.93],'YData', [0 size(rgb,1)*0.93])
...
h1 = figure;
iptsetpref('ImshowAxesVisible','on');
imshow(gray_image,'XData',[0 size(gray_image,2)*0.93],'YData', [0 size(gray_image,1)*0.93])
xlabel('Unit in \mum', 'FontSize', 14);
ylabel('Unit in \mum', 'FontSize', 14);
cbar = colorbar;title(cbar, yname);
...
h4 = figure;
iptsetpref('ImshowAxesVisible','on');
imshow(gray_image,[threshold, 100],'XData',[0 size(gray_image,2)*0.93],'YData', [0 size(gray_image,1)*0.93])
xlabel('Unit in (\mum)', 'FontSize', 14);
ylabel('Unit in (\mum)', 'FontSize', 14);
...
xlabel('Crystal size (pixel)','FontSize',14)
ylabel('Number of Crystals','FontSize',14)
set(gca,'fontsize',20);
